...
//			本文件使用的宏定义
//-----------------------------------------------
//const char timeip[]="time.windows.com";
const char timeip[] = "119.167.163.7";
//const char urrl[] = "time.windows.com";
//-----------------------------------------------
//		本文件使用的结构体，共用体，枚举
//-----------------------------------------------
...
void nwy_update_time_cb(void *handle, nwy_updatetime_errid err_code, nwy_time_t *time)
{
    ...
    {
        nwy_ext_echo("timeupdataOK:%d", err_code);
        nwy_set_time(time, 8);
    }
    else
    {
        nwy_ext_echo("timeupdataerr:%d", err_code);
    }
}
//--------------------------------------------------
//功能描述:
