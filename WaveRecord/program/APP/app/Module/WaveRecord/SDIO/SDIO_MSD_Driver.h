...
#define SDIOC_PWR_EN_PORT               (PortA) //µÕ”––ß
#define SDIOC_PWR_EN_PIN                (Pin05)
...
#define _card_enable() PORT_ResetPortData(SPI_NSS_PORT, SPI_NSS_PIN)
#define _card_disable()  PORT_SetPortData(SPI_NSS_PORT, SPI_NSS_PIN)
#define _card_power_on() //PORT_ResetPortData(SDIOC_PWR_EN_PORT, SDIOC_PWR_EN_PIN)
#define _card_insert() 0 // GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)
