...
#define __CPU_API_H
  ...
  #include ".\HC32F460\cpuHC32F460.h"
#endif
...
#define SOfTWARECOMPARISON_TASK			23
#define UPDATEPROG_TASK			        24
#define RTCRESET_TASK			        25
...
typedef struct TUpdateProgSafeMem_t
{
	...
	TUpdateProgMessage UpdateProgMessage[PROGRAM_FLASH_SECTOR/128];
