...
#define FLASH_SECTOR_SIZE		EFM_SECTOR_SIZE   //8K
#define FLASH_SECTOR0_NUM (FLASH_APP_START_ADDR / FLASH_SECTOR_SIZE)
#define FLASH_SECTOR_NUM  ((FLASH_APP_END_ADDR - FLASH_APP_START_ADDR) / FLASH_SECTOR_SIZE)/* APP扇区数 */
