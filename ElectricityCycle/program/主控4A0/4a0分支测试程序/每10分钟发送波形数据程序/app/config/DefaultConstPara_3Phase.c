...
//波形计算系数
const TSampleUIK UIFactorConst =
{
	{0.0003727275,0.0003729942,0.0003727564},
	{0.0000101396125,0.0000101213525,0.0000100959},
	{0x00000000},
};
...
0x00001540,//ADCCTL 电压1倍增益、电流2倍
	0x0000381A,//HFCONST0x000030C6
	0x0000002E,//PSTART
	0X00000000,//MODSEL
...
const DWORD SampleAdjustDefData[27] = 
{
	...
	0x000000AE, 0x000000B9, 0x000000D9,	//GSU
	0x0000019B, 0x0000016D, 0x00000149,	//GSI
...
const TCommPara CommParaConst =
{
	...
	.ComModule = 0x4A,  //模块读写参数,115200
	.WaveData4g = 0x4D, //给模块发送波形数据,921600
