...
#define	PHASE_RA	PHASE_A			//基波A相
#define	PHASE_RB	PHASE_B			//基波B相
#define	PHASE_RC	PHASE_C			//基波C相


#define	BASE		0x0100			//基波
#define	HARMONIC	0x0200			//谐波
#define	INTERHAR	0x0300			//间谐波
#define THD			0x0400			//总谐波畸变率
#define GROUP		0x0500			//谐波群含量
#define INTERGROUP	0x0600			//间谐波群含量
...
#define	REMOTE_U_AVE	0x0011		//一分钟平均电压
#define	REMOTE_I_AVE	0x0012		//一分钟平均电流	
#define	REMOTE_P_P		0x0013		//正向有功功率（谐波）
#define	REMOTE_N_P		0x0014		//反向有功功率（谐波）
...
#define CS_SPI_SAMPLE1					13
#define CS_SPI_SAMPLE2					14
#define CS_SPI_SAMPLE3					15
#define CS_SPI_SAMPLE4					16
#define CS_SPI_ESAM						17
...
#define BOARD_HC_SEPARATETYPE			36000//分离式导轨表
...
typedef enum
{
	...
	eCOMPONENT_SPI_HSDC1,		//计量芯片HSDC接口  
	eCOMPONENT_SPI_HSDC2,		//计量芯片HSDC接口  
	eCOMPONENT_SPI_HSDC3,		//计量芯片HSDC接口  
	eCOMPONENT_SPI_HSDC4,		//计量芯片HSDC接口  
