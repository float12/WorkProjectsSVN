...
typedef enum
{
	...
	// 有功功率反向（总）
	eSYS_STATUS_OPPOSITE_P1,//总 A B C一定要按顺序相连
	// A相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P1_A,
	// B相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P1_B,
	// C相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P1_C,
	// 无功功率反向（总）
	eSYS_STATUS_OPPOSITE_Q1,//总 A B C一定要按顺序相连
	// A相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q1_A,
	// B相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q1_B,
	// C相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q1_C,
	// 有功功率反向（总）
	eSYS_STATUS_OPPOSITE_P2,//总 A B C一定要按顺序相连
	// A相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P2_A,
	// B相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P2_B,
	// C相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P2_C,
	// 无功功率反向（总）
	eSYS_STATUS_OPPOSITE_Q2,//总 A B C一定要按顺序相连
	// A相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q2_A,
	// B相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q2_B,
	// C相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q2_C,
	// 有功功率反向（总）
	eSYS_STATUS_OPPOSITE_P3,//总 A B C一定要按顺序相连
	// A相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P3_A,
	// B相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P3_B,
	// C相有功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_P3_C,
	// 无功功率反向（总）
	eSYS_STATUS_OPPOSITE_Q3,//总 A B C一定要按顺序相连
	// A相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q3_A,
	// B相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q3_B,
	// C相无功功率反向（由采样芯片判断）
	eSYS_STATUS_OPPOSITE_Q3_C,
	// 电流逆相序
