...
//修改记录	
//----------------------------------------------------------------------
#ifndef __CPUHC32F4A0_H
#define __CPUHC32F4A0_H

#if ( (CPU_TYPE == CPU_HC32F4A0) )
#include <stdio.h>
#include ".\Libraries\hc32f4a0.h"
#include ".\Libraries\hc32_ddl.h"
#include ".\Libraries\hc32_ll_tmra.h"
#include ".\Libraries\hc32_ll_gpio.h"
#include ".\Libraries\hc32_ll.h"
//-----------------------------------------------
//				宏定义
//-----------------------------------------------
//---------程序比对用到的一些宏定义------------------------
...
#define CLEAR_WATCH_DOG					WDT_FeedDog() //HT_WDT->WDTSET = 0xAA3F//FeedWDT per 4s
...
#define SPD_HDSC_MCU	SPD_192000K 		//华大460主频选择
...
#define SCI_MCU_USART7_NUM			6
#define SCI_MCU_USART8_NUM			7
#define SCI_MCU_USART9_NUM			8
#define SCI_MCU_USART10_NUM			9
