...
#define 	DLT645_FACTORY_FOLLOW_ID	(0xeeeeee02)
...
//				变量声明
//-----------------------------------------------
extern char MeterReverAddr[6];				//地址倒叙方便发送
extern char ModuleReverAddr[6];	
extern char MeterWaveAddr[6];	
extern char ModuleWaveAddr[6];	
...
extern DWORD dwReadMeterFlag[MAX_SAMPLE_CHIP] ;
...
//备注:  
//--------------------------------------------------
// void  api_ReadMeterTask645( BYTE bStep,BYTE* bWaveAddr );
//----------------------------------------
//功能描述:  扩展规约检测或设置地理位置
//         
