...
namespace WindowsTest
{
    class BLE_Info
    {
        ...
        public static ushort GetServiceName_INT(GattDeviceService service)
        {
            BLE_Info.GattNativeServiceUuid serviceName;
            if (Enum.TryParse(ConvertUuidToShortId(service.Uuid).ToString(), out serviceName))
            {
                return (ushort)serviceName;
            }
            return 0;
        }
        ...
        public static ushort GetCharacteristicName_INT(GattCharacteristic characteristic)
        {
            ...
            if (Enum.TryParse(ConvertUuidToShortId(characteristic.Uuid).ToString(),
                out characteristicName))
            {
                return (ushort)characteristicName;
            }
