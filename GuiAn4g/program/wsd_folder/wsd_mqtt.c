...
//			本文件使用的宏定义
//-----------------------------------------------
#define MQTT_USER_RECON_INTERVAL 5 //mqtt用户重连间隔,以分钟为单位，5min
#define HEART_SECOND_COUNT 150//根据线程睡眠时间粗略计算 400ms*HEART_SECOND_COUNT
//-----------------------------------------------
//		本文件使用的结构体，共用体，枚举
//-----------------------------------------------
typedef struct
...
TDataTable FKDataTable = {
	...
	.NextTable[2] = &(TDataTable){
		...
		.NextTable[0] = &(TDataTable){
			...
			.MqttData.DataName = "0000",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eFreq,
		},
		.NextTable[1] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
		...
		.NextTable[4] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0101",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eIa,
		},
		.NextTable[5] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0102",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eIb,
		},
		.NextTable[6] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0103",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eIc,
		},
		.NextTable[7] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0200",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eActPAll,
		},
		.NextTable[8] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0201",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eActPa,
		},
		.NextTable[9] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0202",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eActPb,
		},
		.NextTable[10] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0203",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eActPc,
		},
		.NextTable[11] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0300",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eReactPAll,
		},
		.NextTable[12] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0301",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eReactPa,
		},
		.NextTable[13] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0302",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eReactPb,
		},
		.NextTable[14] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0303",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eReactPc,
		},
		.NextTable[15] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0400",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eAppPAll,
		},
		.NextTable[16] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0401",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eAppPa,
		},
		.NextTable[17] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0402",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eAppPb,
		},
		.NextTable[18] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0403",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eAppPc,
		},
		.NextTable[19] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0500",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = ePFAll,
		},
		.NextTable[20] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0501",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = ePFa,
		},
		.NextTable[21] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0502",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = ePFb,
		},
		.NextTable[22] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0503",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = ePFc,
		},
		.NextTable[23] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0600",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eTotalFwdActEp,
		},
		.NextTable[24] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0601",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eFwdActEpa,
		},
		.NextTable[25] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0602",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eFwdActEpb,
		},
		.NextTable[26] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0603",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eFwdActEpc,
		},
		.NextTable[27] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0700",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eTotalRevActEp,
		},
		.NextTable[28] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0701",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eRevActEpa,
		},
		.NextTable[29] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0702",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eRevActEpb,
		},
		.NextTable[30] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "0703",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eRevActEpc,
		},
		.NextTable[31] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "1000",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop1RelayStatus,
		},
		.NextTable[32] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "1001",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop1RelayChangeTime,
		},
		.NextTable[33] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "1002",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop1RelayChangeReason,
		},
		.NextTable[34] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "2000",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop2RelayStatus,
		},
		.NextTable[35] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "2001",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop2RelayChangeTime,
		},
		.NextTable[36] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "2002",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop2RelayChangeReason,
		},
		.NextTable[37] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "3000",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop3RelayStatus,
		},
		.NextTable[38] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "3001",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop3RelayChangeTime,
		},
		.NextTable[39] = &(TDataTable){
			.CJsonFunc = cJSON_AddNumberToObject,
			.MqttData.DataName = "3002",
			.MqttData.DataType = eFromCollection,
			.MqttData.ValueType = eLoop3RelayChangeReason,
		},
	}
};
...
//				本文件使用的变量，常量
//-----------------------------------------------
TRelayChangeReason *pRelayLastChangeReason[METER_PHASE_NUM] = {0};
...
BYTE UserSubTopic[][50] = {"/SharedChargingPile/devices/relayControl","/SharedChargingPile/devices/ParaSet"};
BYTE RelayStatusTopic_Pub[] = "/SharedChargingPile/devices/RelayStatus";
BYTE RecRelayCmdTopic_Pub[] = "/SharedChargingPile/devices/RecRelayCmd";
BYTE ParaSetAckTopic_Pub[] = "/SharedChargingPile/devices/ParaSetAck";
BYTE HeartTopic_Pub[] = "/SharedChargingPile/devices/reportHeart";
...
//通用发布主题名
static char general_pub_topic[64] = "/devices/GuiAn/wisdom_pub";
//通用订阅主题名
static char general_sub_topic[64] = "/devices/GuiAn/wisdom_sub";
//发布主题尾
...
//mqtt维护端服务器 订阅透传专用主题
const char TransitCommonTopic[] = "WSD/Trans/Common/2015";//设置时广播主题 与 下发透传全8地址不能同时使用！！！
...
#if( CYCLE_REPORT_PROTOCAL ==  PROTOCOL_MQTT)
double DoubleData[MAX_SAMPLE_CHIP][COLLECT_DOUBLE_DATA_ITEM_NUM + 9];//最后9个是三回路继电器状态和跳合闸时间、原因
#endif
...
// 备注:
//--------------------------------------------------
QWORD ParseRelayTime(BYTE* time)
{
	TRealTimer t = {0};
	QWORD timestamp = 0;

	t.wYear = (time[0] >> 4) * 10 + (time[0] & 0x0F) + 2000;
	t.Mon   = (time[1] >> 4) * 10 + (time[1] & 0x0F);
	t.Day   = (time[2] >> 4) * 10 + (time[2] & 0x0F);
	t.Hour  = (time[3] >> 4) * 10 + (time[3] & 0x0F);
	t.Min   = (time[4] >> 4) * 10 + (time[4] & 0x0F);
	t.Sec   = (time[5] >> 4) * 10 + (time[5] & 0x0F);
	// nwy_ext_echo("\r\nrelay time:%d-%d-%d %d:%d:%d", t.wYear, t.Mon, t.Day, t.Hour, t.Min, t.Sec);
	timestamp = getmktimems(&t);
...
// 备注:
//--------------------------------------------------
BOOL RemessageF(MQTTClient *client, const char *type, char *topic_p, char *fmt, ...)
{
	va_list args;
	if(fmt != NULL)
	{
	...
	cJSON_AddStringToObject(pJsonRoot, "ID", LtuAddr);
	c_message = cJSON_PrintUnformatted(pJsonRoot);
	// 发布部分
	memset(paho_mqtt_at_param.message, 0, sizeof(paho_mqtt_at_param.message));
	strncpy(paho_mqtt_at_param.message, c_message, strlen(c_message));
	...
	pubmsg.retained = paho_mqtt_at_param.retained;
	pubmsg.dup = 0;
	int rc = nwy_MQTTPublish(client, paho_mqtt_at_param.topic, &pubmsg);
	if (rc)
	{
...
{
	RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &device_full_name_topics[eUpGradeAck][0], "ds", "code", 200.0l, "msg", "SUCCESS");
	RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "ds", "code", 200.0l, "msg", "SUCCESS");
...
void MQTT_Services(void)
{
	...
	if (nwy_get_msg_que(MqttResMessageQueue, &msg, 0xffffffff)) // 等待一秒
	{
		...
		{ // 升级
			...
			if (strcmp(reqbuf, "Meter_upgrade_698") == 0)
			{
				...
				{
					RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "ds", "code", 200.0l, "msg", "698 upgrade in progess");
				}
			}
			else if (strcmp(reqbuf, "Meter_upgrade_645") == 0)
			{
				...
				{
					RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "ds", "code", 200.0l, "msg", "645 upgrade in progess");
				}
			}
			else
			{
				...
				{
					RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "ds", "code", 200.0l, "msg", "4G upgrade in progess");
				}
			}
			cJSON_Delete(pRoot);
		}
		...
		{ // 读版本
			...
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_APPVERSION", &general_pub_topic[0], "s", "apptime", APP_BUILD_TIME);
			cJSON_Delete(pRoot);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_GETTIME"))
		{ // 读时钟
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_GETTIME", &device_full_name_topics[eGetTimeAck][0], "s", "DateTime", get_N176_time_stringp());
			cJSON_Delete(pRoot);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_SETTIME"))
		{
			...
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_SETTIME", &device_full_name_topics[eSetTimeAck][0], "");
			cJSON_Delete(pRoot);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_GETRAM"))
		{
			nwy_dm_get_device_heapinfo(reqbuf);
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_GETRAM", &general_pub_topic[0], "s", "DeviceRam", reqbuf);
			cJSON_Delete(pRoot);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_RESET"))
		{
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_RESET", &general_pub_topic[0], "s", "Status", "StartReset");
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_RESET", &device_full_name_topics[eResetAck][0], "s", "Status", "StartReset");
			nwy_power_off(2);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_SINGAL"))
		{
			...
			double temp = bcsq;
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_SIGNAL_STRENGTH", &general_pub_topic[0], "d","Signal",temp );
			cJSON_Delete(pRoot);
		}
		else if (strstr(pType->valuestring, "CMD_DEVICE_SET_SERVER_PARA"))
		{
			...
			{
				RemessageF(&paho_mqtt_client,"CMD_DEVICE_SET_SERVER_PARA", &general_pub_topic[0], "s", "Status", "ServerNo error");
				cJSON_Delete(pRoot);
			}
			else
			{
				...
				RemessageF(&paho_mqtt_client,"CMD_DEVICE_SET_SERVER_PARA", &general_pub_topic[0], "s", "Status", "CMD_DEVICE_SET_SERVER_PARA");
				RemessageF(&paho_mqtt_client,"CMD_DEVICE_SET_SERVER_PARA", &device_full_name_topics[eSetServerParaAck][0], "s", "Status", "CMD_DEVICE_SET_SERVER_PARA");
				nwy_power_off(2);
			}
		}
		...
		{ 
			...
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_SET_REPORT_PARA", &general_pub_topic[0], "s", "Status", "CMD_DEVICE_SET_REPORT_PARA");
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_SET_REPORT_PARA", &device_full_name_topics[eSetReportParaAck][0], "s", "Status", "CMD_DEVICE_SET_REPORT_PARA");
			nwy_power_off(2);
		}
		...
		{ 
			api_OperateFileSystem(READ,0,(BYTE*)&SafeMem,sizeof(SafeMem));
			// 读参数
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_GET_PARA", &general_pub_topic[0], "sdsssdssdsd", 
	...
	if (nwy_get_msg_que(UpgradeResultMessageQueue, &UpgradeReply, 0xffffffff))
	{
		...
		{
		case eUpgradeExeSuc:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "execute Upgrade successful");
			break;
		case eUpgrdeFrameTimeoutErr:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "Frame timeout error");
			break;
		case eUpgradeCheckResultErr:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "Check result error");
			break;
		case eUpgradeVeriErr:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "file Verification error");
			break;
		case eUpgradeDARErr:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "DAR error");
			break;
		case eUpgradeWholeProTimeoutErr:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "Whole process timeout error");
			break;
		case eFtpLoginSuccess:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "ftp login success");
			break;
		case eFtpDownLoadSuccess:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "ftp download success");
			break;
		case eFtpModuleUpgradeFail:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "ftp module upgrade fail");
			break;
			break;
		case eFtpFailExit:
			RemessageF(&paho_mqtt_client,"CMD_DEVICE_UPGRADE", &general_pub_topic[0], "s", "upgradeResult", "ftp module upgrade fail exit");
			break;
		default:
			break;
		}
...
void MQTT_connet(void)
{
	...
	if (MQTTIsConnected(&paho_mqtt_client))
	{
		...
		for (int i = 0; i <sizeof(device_sub_topics_tail)/sizeof(device_sub_topics_tail[0]); i++)
		{
			...
			if (rc == SUCCESS)
			{
				nwy_ext_echo("\r\nMQTT Sub ok:%s",paho_mqtt_at_param.topic);
			}
			else
				nwy_ext_echo("\r\nMQTT Sub error:%d", rc);
		}
		//订阅general_sub_topic
		rc = MQTTSubscribe(&paho_mqtt_client, general_sub_topic, paho_mqtt_at_param.qos, messageArrived);
		if (rc == SUCCESS)
		{
			nwy_ext_echo("\r\nMQTT Sub gen topic ok:%s",general_sub_topic);
		}
		else
			nwy_ext_echo("\r\nMQTT Sub gen topic error:%d", rc);
		//订阅 基表地址为主题 只用来 批量或同时透传设置多个 基表参数
		nwy_ext_echo("\r\n ltu:[%s]\r\n",LtuAddr);
		memcpy(&TransitSingleTopic[17],LtuAddr,strlen(LtuAddr));//！！！使用strlen拼接时注意第二次会往后追加拼接，直接拷贝'\0'
...
// 备注:
//--------------------------------------------------
static BOOL pub_cycledatatoUser(CollectionDatas *pCollectData);
...
#if (CYCLE_METER_READING == YES)
//--------------------------------------------------
// 功能描述:	判断继电器状态返回最新的跳闸或合闸记录信息
//
// 参数:
//			LOOP[in] 回路号
// 返回值:
//			TRelayChangeReason* 跳合闸记录信息
// 备注:
//--------------------------------------------------
TRelayChangeReason* CheckRelayStatusChange(BYTE LOOP)
{
	if (gRelayStatus[LOOP] == eRELAY_CLOSE)
	{
		return (TRelayChangeReason*)&RelayChangeReason[LOOP][1];
	}
	else if (gRelayStatus[LOOP] == eRELAY_OPEN)
	{
		return (TRelayChangeReason*)&RelayChangeReason[LOOP][0];
	}
	else
	{
		nwy_ext_echo("\r\n relay status error, loop:%d, relay status:%d", LOOP, gRelayStatus[LOOP]);
		return NULL;
	}
}
//--------------------------------------------------
...
static BOOL pub_cycledatatoUser(CollectionDatas *pCollectData) //大数据用指针传参
{
	...
	// nwy_ext_echo("\r\npaho_mqtt_user_param.topic:%s", paho_mqtt_user_param.topic);
	...
	memcpy((double *)&DoubleData[0][0], (double *)&pCollectData->CollectMeter[0][0], sizeof(double) * (COLLECT_DOUBLE_DATA_ITEM_NUM));
	
	for(i = 0; i < METER_PHASE_NUM; i++)
	{
		pRelayLastChangeReason[i] = CheckRelayStatusChange(i);
		if(pRelayLastChangeReason[i] == NULL)
		{
			nwy_ext_echo("\r\n relay status change info not found, loop:%d", i);
			continue;
		}
		DoubleData[0][COLLECT_DOUBLE_DATA_ITEM_NUM + i * 3] = (double)gRelayStatus[i];
		DoubleData[0][COLLECT_DOUBLE_DATA_ITEM_NUM + 1 + i * 3] = (double)ParseRelayTime(pRelayLastChangeReason[i]->Time);
		DoubleData[0][COLLECT_DOUBLE_DATA_ITEM_NUM + 2 + i * 3] = (double)(BYTE)pRelayLastChangeReason[i]->Reason;
	}
	pJsonRoot1 = DataToCJson(&FKDataTable, NULL, 0, 0, NULL, pCollectData->TimeMs, Addru);

	
	c_message = cJSON_PrintUnformatted(pJsonRoot1);
	// nwy_ext_echo("\r\nc_message is %s", c_message);
	// 发布部分
	...
	// nwy_ext_echo("\r\nstrlen(c_message) = %d", strlen(c_message));
...
void MQTT_UserServices(void)
{
	...
	if (nwy_get_msg_que(MqttResUserMessageQueue, &msg, 0xffffffff)) // 等待一秒
	{
		...
		cJSON_GetObjectValue(pRoot, "ID", ecJSON_String, RecID, sizeof(RecID));
		if((strcmp((char *)RecID, (char *)LtuAddr) != 0) && (strcmp((char *)RecID, (char *)"888888888888") != 0))
		{
			nwy_ext_echo("\r\n ID not match, rec ID:%s, meter ID:%s", (char *)RecID, (char *)LtuAddr);
			cJSON_Delete(pRoot);
		}
		else
		{
			...
			{
				cJSON_GetObjectValue(pRoot, "OffLineOpenRelayMin", ecJSON_Int, &OffLineOpenRelayMin, sizeof(OffLineOpenRelayMin));
				memcpy((BYTE*)&ReportPara.OfflineOpenRelayMin,(BYTE*)&OffLineOpenRelayMin,sizeof(ReportPara.OfflineOpenRelayMin));
				addr = GET_SAFE_SPACE_ADDR(ReportPara.OfflineOpenRelayMin);
				if(api_OperateFileSystem(WRITE,addr,(BYTE*)&ReportPara.OfflineOpenRelayMin,sizeof(ReportPara.OfflineOpenRelayMin)) == TRUE)
				{
					RemessageF(&paho_user_client,"CMD_DEVICE_SET_PARA", (char *)&ParaSetAckTopic_Pub[0], "s", "Result", "OK");
				}
				else
				{
					RemessageF(&paho_user_client,"CMD_DEVICE_SET_PARA", (char *)&ParaSetAckTopic_Pub[0], "s", "Result", "ERROR");
				}
				cJSON_Delete(pRoot);
			}
			else
...
void MQTT_connetUser(void)
{
	...
	// 连接服务器
	memcpy(paho_mqtt_user_param.host_name, Serverpara[1].ServerIP, sizeof(Serverpara[0].ServerIP));
	paho_mqtt_user_param.port = Serverpara[1].ServerPort;
	...
	memcpy(paho_mqtt_user_param.username, Serverpara[1].ServerUserName, sizeof(Serverpara[0].ServerUserName));
	memcpy(paho_mqtt_user_param.password, Serverpara[1].ServerUserPwd, sizeof(Serverpara[0].ServerUserPwd));
	// nwy_ext_echo("\r\npaho_mqtt_user_param.username is %s", paho_mqtt_user_param.username);
	// nwy_ext_echo("\r\npaho_mqtt_user_param.password is %s", paho_mqtt_user_param.password);
	...
	nwy_ext_echo("\r\nConnecting user MQTT");
	rc = nwy_MQTTConnect(&paho_user_client, &datatemp);
	if (rc)
	{
		nwy_ext_echo("\r\nuser Failed to create client, return code %d", rc);
	...
	else
	{
		...
		{
			for(i = 0; i < sizeof(UserSubTopic) / sizeof(UserSubTopic[0]); i++)
			{
				rc = MQTTSubscribe(&paho_user_client, (char *)UserSubTopic[i], paho_mqtt_user_param.qos, UserMessageArrived);
				if (rc != SUCCESS)
				{
					nwy_ext_echo("\r\n user MQTT Sub err  ");
				}
			...
			if (0 != nwy_ext_check_data_connect())
			{
				if (MQTTIsConnected(&paho_user_client) != 1)
				{
					...
					if (MQTTIsConnected(&paho_user_client) != 1) //没有连接成功，再进行延时，连接成功不再进行延时
					{
						...
						{
							Connectfre++;
							nwy_ext_echo("\r\nConnectfre %d,ReportPara.OfflineOpenRelayMin %d", Connectfre, ReportPara.OfflineOpenRelayMin);
							UserMqttReconnectTimerFlag = 0;
							nwy_start_timer(User_MQTT_Reconnect_timer, 60000*MQTT_USER_RECON_INTERVAL);//5分钟重连一次
