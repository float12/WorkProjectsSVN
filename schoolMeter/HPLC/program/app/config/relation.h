...
#if ( (MAX_COM_CHANNEL_NUM > 4) || (MAX_COM_CHANNEL_NUM < 2) )
"串口数目配置不对"
#endif
	...
	#endif
#else
	#if( (cMETER_VOLTAGE!=METER_100V) && (cMETER_VOLTAGE!=METER_380V) )
	电压配置不对
	#endif
...
#if( (( BOARD_TYPE != BOARD_HT_SINGLE_78202303) && (BOARD_TYPE != BOARD_HT_SINGLE_78202401)) && (SLE_THIRD_MEM_BACKUP == YES))
	#error "配置错误"
#endif
