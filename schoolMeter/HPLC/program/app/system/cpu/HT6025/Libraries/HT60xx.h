...
typedef struct
{
    ...
    __IO uint32_t TRIREQ;                   /*!< Offset: 0x040  */
    __IO uint32_t TBSTESTCTRL;              /*!< Offset: 0x044  */
    __IO uint32_t TBSINJECTCTRL;            /*!< Offset: 0x048  */
#endif  
#endif    
...
typedef struct
{
    ...
    __IO uint32_t LFDETCFG;                 /*!< Offset: 0x200 LF 停振检测配置寄存器(写保护)  (R/W)       */ 
    __IO uint32_t MULTFUNCFG;               /*!< Offset: 0x204 多功能配置寄存器(写保护)       (R/W)       */ 
    __IO uint32_t LFCLKCFG;                 /*!< Offset: 0x208 低频时钟源配置寄存器(写保护)   (R/W)       */ 
    __I  uint32_t OSCSTA;                   /*!< Offset: 0x20C OSC 状态寄存器               (R/W)       */ 
    __I  uint32_t Reserved6[2+10*4+14*64-110];             
    __I  uint32_t CHIPID;                   /*!< Offset: 0xF00 ChipID (R)                                */
#endif
...
typedef struct
{
    ...
    __IO uint32_t FILT;                     /*!< Offset: 0x024 保留寄存器 (R/W) */
    __IO uint32_t RESERVED2;                /*!< Offset: 0x028 保留寄存器 (R/W) */
    __IO uint32_t NEWAFEN;                  /*!< Offset: 0x02C 新增复用功能生效控制寄存器 (R/W) */
...
#define HT_SPI3_BASE         (HT_APB0_BASE + 0x15000)
#endif
