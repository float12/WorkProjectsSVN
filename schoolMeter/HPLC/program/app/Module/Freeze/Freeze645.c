...
static const TLpfClosing645Map	Closing645MapTab[] =
{
	...
	{ 0x0015,		0,	4,	0x00110200, 	FreezeEnergyBlock645Transform 		},  //A相正向有功电能数据块
	{ 0x0029,		0,	4,	0x00120200, 	FreezeEnergyBlock645Transform 		},  //B相正向有功电能数据块
	{ 0x003D,		0,	4,	0x00130200, 	FreezeEnergyBlock645Transform 		},  //C相正向有功电能数据块
#endif
};
